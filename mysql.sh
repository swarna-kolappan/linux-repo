...
service mysql stop && yum remove -y mysql-community-server && rm -rf /var/lib/mysql && rm -rf /var/log/mysqld.log

echo ' -> Installing mysql database server';
yum localinstall -y https://dev.mysql.com/get/mysql-community-release-el6-5.noarch.rpm
